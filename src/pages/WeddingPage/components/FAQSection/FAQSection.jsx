...
export default function FAQSection() {
   ...
   const faqData = [
      ...
      { q: "¿Cuentan con estacionamiento propio?", a: "Sí, el local cuenta con un área privada de estacionamiento muy seguro. Sin embargo, si planean beber, recomendamos ampliamente el uso de Taxis/Didi/Uber de la ciudad." },
      ...
      { q: "¿El regalo debe ser un objeto físico?", a: "No es obligatorio. Sugerimos aportaciones voluntarias a la cuenta bancaria de la Mesa de Regalos ('Lluvia de Sobres'), pero cualquier detalle físico también será muy apreciado allí." }
   ];
