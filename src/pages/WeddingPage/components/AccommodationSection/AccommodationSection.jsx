...
export default function AccommodationSection() {
  return (
    <section className="bg-transparent py-12 md:py-24 px-6 md:px-12 border-t border-black/5">
      <h2 className="font-serif mb-12 md:mb-16 text-text-primary text-[26px] leading-[1.15] font-medium md:text-5xl lg:text-6xl flex flex-nowrap justify-center items-center gap-2 md:gap-5 text-center px-1 w-full">
