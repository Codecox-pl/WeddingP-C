          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <AnimatePresence>
              {error && (
                ...
                >
                  <p className="text-red-500 font-sans text-[11px] leading-[1.5] tracking-[2px] uppercase font-[700] bg-red-50 py-2 rounded-sm w-max mx-auto px-4 border border-red-100">
                    {error}
                  </p>
                </motion.div>
              )}
            ...
            <button 
              type="submit" 
              disabled={isLoading}
              className="w-full py-4 mt-2 bg-[#bfa18f] hover:bg-[#a68c7c] text-white font-sans text-[11px] leading-[1.5] font-[700] tracking-[4px] uppercase transition-colors shadow-sm disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center"
            >
              {isLoading ? (
