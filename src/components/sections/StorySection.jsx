...
export default function StorySection() {
  return (
    <section className="max-w-6xl mx-auto py-16 md:py-24 px-6 sm:px-12 flex flex-col md:flex-row items-center gap-16">
      <div className="w-full md:w-1/2 flex justify-center">
        <div className="bg-white p-4 pb-16 shadow-xl rotate-[-2deg] max-w-sm w-full border border-gray-100">
          <div
      ...
      <div className="w-full md:w-1/2">
        <h2 className="font-serif mb-6 md:mb-12 text-text-primary text-[32px] leading-[1.15] md:text-5xl lg:text-6xl font-[500] flex flex-nowrap justify-center md:justify-start items-center gap-2 md:gap-5 text-center md:text-left w-full">
        ...
        <p className="font-serif italic text-2xl sm:text-xl lg:text-4xl mt-10 text-accent text-center md:text-left font-[500] leading-normal">
